...
def optimize_and_train(dataset_path, option_name, optimize_for='F1', beta=2.0):
    ...
    output_dir = f"v4-models/{option_name}/{optimize_for}"
    ...
    report_text = f"=== REPORTE V4 {option_name} ({optimize_for}) ===\n"
...
if __name__ == "__main__":
    datasets = {
        "OptionB": "../datasets/v4/dataset_v4_optionB.parquet",
        "OptionC": "../datasets/v4/dataset_v4_optionC.parquet",
    }
