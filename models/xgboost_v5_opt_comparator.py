...
def optimize_and_train(dataset_path, option_name, optimize_for='F1', beta=2.0):
    ...
    output_dir = f"v5-models/{option_name}/{optimize_for}"
    ...
    report_text = f"=== REPORTE V5 {option_name} ({optimize_for}) ===\n"
...
if __name__ == "__main__":
    datasets = {
        "OptionB": "../datasets/v5/dataset_v5_optionB.parquet",
        "OptionC": "../datasets/v5/dataset_v5_optionC.parquet",
    }
