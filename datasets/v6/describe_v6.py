...
# -*- coding: utf-8 -*-
"""
Script para generar gráficas descriptivas del dataset v6:
...
# Dataset base con todas las estancias (mismo que se usa para generar v4/v6)
df_all_stays = pd.read_parquet('data/processed/covid_icu_dataset_v3_all_stays.parquet')
df_v6_optionB = pd.read_csv('notebooks/datasets/v6/dataset_v6_optionB.csv')
df_v6_optionC = pd.read_csv('notebooks/datasets/v6/dataset_v6_optionC.csv')
...
n_final_optionB = len(df_v6_optionB)
n_final_optionC = len(df_v6_optionC)
...
# Título
ax.text(5, 11.7, 'Criterios de Inclusión - Dataset v6', 
...
# Imprimir en consola
print("\n" + "="*80)
print("TABLE ONE - COVID-19 ICU COHORT (Dataset v6)")
...
title_text = ('Table 1: Características de la Cohorte COVID-19 UCI (Dataset v6 - Opción B)\n'
...
print(f"  • Variables en v6: {len(df_v6_optionB.columns)} columnas")
print("="*60)
